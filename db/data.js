const produce = [
  ...
  },
  {
    ...
    description:
      "Cranberries are tart, red berries which are most famously used in winter recipes. They are naturally high in a wide range of vitamins and minerals, and can contribute powerfully to a varied and balanced diet. At their best between October and December, cranberries can be used in a wide variety of dishes, such as in making sauces, desserts, to dress meats, and in drinks. Look for plump, firm, bright berries when you are shopping for fresh cranberries. You can also buy them dried! Cranberries can be grown at home in the UK, whether in pots or as ground shrubs, though they do also grow wild throughout North Europe and North America. ",
    family: "Heath",
    foodType: "Berry",
    usedAs: "Fruit",
  ...
  },
  {
    ...
    description:
      "Lemons are sour citrus fruits which can be used in a very wide variety of sweet and savoury dishes. They are bright yellow in colour, and have a very high amount of vitamin C. Though the flesh is a little strong to eat on its own, the skin can be zested and added to lots of different meals, and the juice and flesh are great when cooked into other things. Lemon wedges are a great side to serve with fish and meat, or to be added to trays during roasting to impart flavour. Lemons can be made into lemonade and other juices, or used to flavour things like cakes and dessert sauces. When buying lemons, look for ones with unblemished and brightly coloured skins. As with all citrus plants, lemons are not hardy in the UK and so are not the easiest to grow, but with some care and access to a greenhouse or indoor space to keep your lemon tree in over the winter, you can have success growing lemons.",
    family: "Citrus",
    foodType: "Citrus",
    usedAs: "Fruit",
    month: ["January", "February", "March"],
  ...
  },
  {
    ...
    description:
      "Spinach is a leafy green vegetable that originated in Persia. It belongs to the amaranth family and is related to beets and quinoa. If you are interested in its health-boosting potential, spinach is an easy food to add to your diet. Spinach is rich in many nutrients, including vitamins A, C and K, iron, folate, and potassium. Spinach is chock-full of fibre too. Spinach may decrease oxidative stress, improve eye health, and help prevent heart disease and cancer. There are three popular ways to cook Spinach: steaming, sauteing and blanching. Either way, this nutrient-dense leafy green vegetable cooks in just minutes for a fast side dish or versatile ingredient. Winter spinach cultivars need a sunny position: summer spinach varieties are better in partial shade, so are among the easiest vegetables to grow in shade.  Once you have harvested your spinach, all you need to do is water it and wait patiently for the next harvest. Spinach leaves will regrow in just a matter of days.",
    family: "Buckwheat",
    foodType: "Leaf",
    usedAs: "Vegetable",
    month: ["April", "May", "June", "July", "August", "September"],
  ...
  },
  {
    ...
    description:
      "Swiss Chard, or leaf beet, is an attractive vegetable, with leaf stalks in an array of bright colours. The stalks - which can be white, yellow, red, purple, pink, striped and so on - resemble flat celery with a sweet taste slightly reminiscent of beets. Swiss chard contains vitamins K and A, and is also a good source of magnesium which helps keep your muscles, bones and nerves healthy. Young leaves can be eaten raw in salads, while larger leaves are delicious cooked. The large, firm leaves are mild, sweet, earthy and just slightly bitter; on the whole, it is a bit milder than spinach. Typically the leaves are boiled for a few minutes. It is similar to spinach but easier to grow. Young chard leaves are delicious eaten fresh and the fully-formed leaves will be ready to harvest about 10-12 weeks after sowing. Cut individual leaves as you need them and the plant will keep producing new growth.",
    family: "Beet",
    foodType: "Leaf",
    usedAs: "Vegetable",
