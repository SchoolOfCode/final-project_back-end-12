...
const produce = [
  ...
  },
  {
    ...
    description:
      "Also known as corn salad or cat grass, lamb&apos;s lettuce has a distinctive, tangy flavour and is known for its long spoon-shaped leaves. Its unusual name allegedly comes from the lettuce&apos;s similarity to the size and shape of a lamb&apos;s tongue. Lamb&apos;s lettuce is an excellent source of vitamin A but is also high in vitamin C, E, K and B6 as well as many minerals. Lamb&apos;s lettuce is best used as a main ingredient in salads or cooked and served as a side vegetable. Be sure to wash and drain thoroughly before use it can be grainy and gritty. It is quickly perishable and should be used within two days of purchase. Lamb&apos;s lettuce thrives in moist soils and cold temperatures so plant them in a shady spot. They do not tolerate drought well so keep them well-watered. To avoid a glut, you should sow little and often.",
    family: "Honeysuckle",
    foodType: "Leaf",
    usedAs: "Vegetable",
    month: [
  ...
  },
  {
    ...
    description:
      "A velvety-skinned stone fruit, peaches are juicy, sweet and fragrant. They generally have red skin and yellow flesh, though there are white varieties which are more pink in colour. The most common type of peach is spherical in shape and about the size of a tennis ball, though you can find disc-shaped varieties too! Ripe peaches should smell fragrant, and will be yellow around their stems. They will feel firm, but will yield slightly if squeezed. Avoid peaches that feel hard or look bruised. Underripe peaches will soften if stored at room temperature, but their taste won&apos;t get much sweeter. If you cut peaches for a raw snack, but aren&apos;t going to eat them right away, brush the exposed flesh with lemon juice to prevent browning. Peaches can be eaten raw and added to fruit salads, pavlovas and trifles. They can also be poached or halved and roasted, and served with cream or ice cream too. An alternative to peaches is nectarines.",
    family: "Rose",
    foodType: "Drupe",
    usedAs: "Fruit",
    month: ["August", "September"],
